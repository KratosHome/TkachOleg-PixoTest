  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "bg-muted relative cursor-pointer grow overflow-hidden rounded-full data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5",
        )}
      >
